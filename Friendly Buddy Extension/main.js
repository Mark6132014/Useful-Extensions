...
function setup() {
    ...
    HTML_MessageDialog.innerHTML = `<small id="emotion">Neutral</small>
        ...
        <hr>
        <input id="chatInput" placeholder="Message your buddy..." style="width: 97%;">
        <center><button id="sendMsg">Send Message</button></center>
        <br>
        <a href="chrome-extension://${chrome.runtime.id}/options.html" style="color: blue; background: transparent;">Extension Options</a>`;
        /* Done with Setup */
